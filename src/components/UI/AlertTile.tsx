    ...
    <div className="col-12">
      <div className="card bd-content p-4">
        ...
        <p>
          ...
          proper styling, use one of the eight <strong>required</strong> contextual classes (e.g.,{' '}
...
<Alert variant='dark'>This is a dark alert—check it out!</Alert>`}
        ...
        <div className="bd-example mb-5">
          {['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'light', 'dark'].map(
            (variant, idx) => (
              <Alert key={idx} variant={variant}>
                This is a {variant} alert with <Alert.Link href="#">an example link</Alert.Link>.
                Give it a click if youlike.
              </Alert>
            )
          )}
...
<p className="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
        ...
        <ul>
          ...
          <li>
            Add a <a href="/docs/5.0/components/close-button/">close button</a> and the{' '}
            <code>.alert-dismissible</code> class, which adds extra padding to the right of the
            alert and positions the close button.
          </li>
          <li>
            On the close button, add the <code>data-dismiss="alert"</code> attribute, which triggers
            the JavaScript functionality. Be sure to use the <code>&lt;button&gt;</code> element
            with it for proper behavior across all devices.
          </li>
          <li>
            To animate alerts when dismissing them, be sure to add the <code>.fade</code> and{' '}
...
<button type="button" className="btn-close" data-dismiss="alert" aria-label="Close"></button>
        ...
        <div className="card mb-3 p-3">
          ...
          reason, we recommend including additional JavaScript that listens for the{' '}
          <code>closed.bs.alert</code> event and programmatically sets <code>focus()</code> to the
          most appropriate location in the page. If you’re planning to move focus to a
...
new bootstrap.Alert(alert)
        ...
        <p>
          Or with <code>data</code> attributes on a button <strong>within the alert</strong>, as
          demonstrated above:
        </p>
        <div className="bd-example mb-5">
...
var bsAlert = new bootstrap.Alert(myAlert)`}
        ...
        <p>
          ...
          <code>data-dismiss="alert"</code> attribute. (Not necessary when using the data-api’s
          auto-initialization.)
        </p>
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <code>.show</code> classes are present on the element, the alert will fade out
            ...
            <tr>
              ...
              <td>
                Static method which allows you to get the alert instance associated to a DOM
                element, you can use it like this: <code>bootstrap.Alert.getInstance(alert)</code>
              </td>
            </tr>
          </tbody>
        </table>
