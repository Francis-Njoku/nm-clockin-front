...
function ReviewCommnetCard() {
  return (
    <ul className="list-unstyled res-set mb-4">
      <li className="card mb-2">
        <div className="card-body p-lg-4 p-3">
          <div className="d-flex border-bottom mb-3 flex-wrap pb-3">
            <img className="avatar rounded-circle" src={Avatar4} alt="" />
            <div className="flex-fill text-truncate ms-3">
              <h6 className="mb-0">
                <span>Peter Allan</span> <span className="small text-muted">1050 Followers</span>
              </h6>
          ...
          <div className="timeline-item-post">
            ...
            <div className="mb-2 mt-4 text-end">
              <a className="me-lg-2 btn btn-primary btn-sm me-1" href="#!">
                <i className="fa fa-thumbs-up"></i>{' '}
                <span className="d-none d-sm-none d-md-inline">Like (105)</span>
              </a>
              <a className="me-lg-2 btn btn-primary btn-sm me-1" href="#!">
                <i className="fa fa-comment"></i>{' '}
                <span className="d-none d-sm-none d-md-inline">Publice Comment</span>
              </a>
              <a className="btn btn-primary btn-sm" href="#!">
                <i className="bi bi-chat-left-text-fill"></i>{' '}
                <span className="d-none d-sm-none d-md-inline">Direct Message</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <li className="card mb-2">
        <div className="card-body p-lg-4 p-3">
          <div className="d-flex border-bottom mb-3 flex-wrap pb-3">
            ...
            <div className="flex-fill text-truncate ms-3">
              <h6 className="mb-0">
                <span>Adrian Allan</span> <span className="small text-muted">650 Followers</span>
              </h6>
      ...
      <li className="card mb-2">
        <div className="card-body p-lg-4 p-3">
          <div className="d-flex border-bottom mb-3 flex-wrap pb-3">
            ...
            <div className="flex-fill text-truncate ms-3">
              <h6 className="mb-0">
                <span>Benjamin Keith</span> <span className="small text-muted">458 Followers</span>
              </h6>
          ...
          <div className="timeline-item-post">
            ...
            <div>
              <div className="d-flex border-top mt-3 pt-3">
                ...
                <div className="flex-fill text-truncate ms-3">
                  <p className="mb-0">
                    <span>Karen Clark</span> <small className="msg-time">5 Day ago</small>
                  </p>
