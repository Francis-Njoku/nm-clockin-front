      ...
      <div className="card-header py-3 d-flex flex-wrap  justify-content-between align-items-center bg-transparent border-bottom-0">
        <div>
          ...
          <small className="text-muted">
            {subTitle1 ? subTitle1 : ''} <a href="#!">{linkText ? linkText : ''}</a>{' '}
            {subTitle2 ? subTitle2 : ''}
          </small>
        </div>
        <Dropdown drop="left">
          ...
          <button className="btn btn-sm btn-link text-muted d-none d-sm-inline-block" type="button">
            <i className="fa fa-external-link"></i>
          </button>
          <Dropdown.Toggle variant="" className="btn btn-sm btn-link text-muted"></Dropdown.Toggle>
          <Dropdown.Menu>
      ...
      <div className="card-body">
        {showBtnGroup ? (
          <div className="btn-group" role="group" aria-label="Basic example">
            ...
            <button type="button" className="btn btn-outline-secondary" id="one_year">
              1Y
            </button>
            <button type="button" className="btn btn-outline-secondary" id="ytd">
              YTD
            </button>
            <button type="button" className="btn btn-outline-secondary" id="all">
              ALL
            </button>
          </div>
        ) : null}
