          ...
          <div className="row g-3 align-items-center">
            <div className="col-md-12">
              <div className="form-group">
                ...
                <input
                  ...
                  value={carector}
                  onChange={(e) => {
                    setCarector(e.target.value)
                  }}
                  required
                  data-parsley-minlength="8"
                />
                {carector.length <= 8 && button ? (
                  <span className="text-danger">Please default checked your input filed</span>
                ) : (
                  ''
                )}
              </div>
            ...
            <div className="col-md-12">
              <div className="form-group">
                ...
                <input
                  ...
                  value={carector2}
                  onChange={(e) => {
                    setCarector2(e.target.value)
                  }}
                  required
                  data-parsley-length="[5,10]"
                />
                {carector2.length <= 5 && button ? (
                  <span className="text-danger">Please default checked your input filed</span>
                ) : (
                  ''
                )}
            ...
            <div className="col-md-12">
              <div className="form-group">
                ...
                {a === false && b === false && c === false && button ? (
                  <span className="text-danger d-block"> meximum Any 2 default checked</span>
                ) : (
                  ''
                )}
              </div>
            ...
            <div className="col-md-12">
              <div className="form-group">
                ...
                {check1 === false && check2 === false && check3 === false && button ? (
                  <span className="text-danger d-block"> meximum Any 2 default checked</span>
                ) : (
                  ''
                )}
