      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="progress-count mt-2">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <h6 className="mb-0 fw-bold d-flex align-items-center">
                5<i className="bi bi-star-fill text-warning ms-1 small-11 pb-1"></i>
              </h6>
          ...
          <div className="progress-count mt-2">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <h6 className="mb-0 fw-bold d-flex align-items-center">
                4<i className="bi bi-star-fill text-warning ms-1 small-11 pb-1"></i>
              </h6>
          ...
          <div className="progress-count mt-2">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <h6 className="mb-0 fw-bold d-flex align-items-center">
                3<i className="bi bi-star-fill text-warning ms-1 small-11 pb-1"></i>
              </h6>
          ...
          <div className="progress-count mt-2">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <h6 className="mb-0 fw-bold d-flex align-items-center">
                2<i className="bi bi-star-fill text-warning ms-1 small-11 pb-1"></i>
              </h6>
          ...
          <div className="progress-count mt-2">
            <div className="d-flex justify-content-between align-items-center mb-1">
              <h6 className="mb-0 fw-bold d-flex align-items-center">
                1<i className="bi bi-star-fill text-warning ms-1 small-11 pb-1"></i>
              </h6>
