...
import { IncomeAnalyticsChartData, ProjectTimelineChartData } from 'global/data/DashboardData'
...
import GeneralChartCardDropDown from 'global/__template/components/Dashboard/GeneralChartCardDropDown'
import ProjectCredentials from 'global/__template/components/Dashboard/ProjectCredentials'
import ProjectInformationTable from 'global/__template/components/Dashboard/ProjectInformationTable'
            ...
            extraDivBody={() => {
              return (
                <div className="d-flex justify-content-end text-center">
                  <div className="p-2">
                    <h6 className="fw-bold mb-0">$5,318</h6>
                    <small className="text-muted">Income</small>
                  </div>
                  <div className="ms-4 p-2">
                    <h6 className="fw-bold mb-0">$2,840</h6>
