...
import { TicketsViewData } from 'global/data/AppData'
          ...
          return (
            <div className="d-flex w-sm-100 col-auto">
              <button
                ...
                <i className="icofont-plus-circle fs-6 me-2"></i>Add Tickets
              </button>
            </div>
          )
        }}
        ...
        <Modal.Body>
          <div className="mb-3">
            ...
            <input
              ...
              id="sub"
              onChange={() => {}}
              value={siEditModal ? siEditModal.subject : ''}
            />
          </div>
              ...
              <div className="row g-3 mb-3">
                <div className="col-lg-6">
                  ...
                  <input
                    ...
                    id="depone"
                    onChange={() => {}}
                    value={siEditModal ? siEditModal.assigned : ''}
                  />
                </div>
                <div className="col-lg-6">
                  ...
                  <input
                    ...
                    id="deptwo"
                    onChange={() => {}}
                    value={siEditModal ? siEditModal.createdate : ''}
                  />
                </div>
              </div>
            </form>
