...
import { OurClientsData } from 'global/data/AppData'
    ...
    <div className="container-xxl">
          ...
          return (
            <div className="d-flex col-auto">
              ...
              <button
                ...
                <i className="icofont-plus-circle fs-6 me-2"></i>Add Client
              </button>
            </div>
          )
        }}
        ...
        <Modal.Body>
          <div className="modal-body">
              ...
              <form>
                <div className="row g-3 mb-3">
                  <div className="col-lg-6">
                    <label htmlFor="exampleFormControlInput177" className="form-label">
                      User Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-lg-6">
                    <label htmlFor="exampleFormControlInput277" className="form-label">
                      Password
                    </label>
                    <input
                      type="Password"
                ...
                <div className="row g-3 mb-3">
                  <div className="col-lg-6">
                    <label htmlFor="exampleFormControlInput477" className="form-label">
                      Email ID
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="col-lg-6">
                    <label htmlFor="exampleFormControlInput777" className="form-label">
                      Phone
                    </label>
                    <input
                      type="text"
            ...
            <div className="table-responsive">
              <table className="table-striped custom-table table">
                <thead>
                  <tr>
      ...
      <Modal
        ...
        <Modal.Body className="justify-content-center flex-column d-flex">
          <i className="icofont-ui-delete text-danger display-2 mt-2 text-center"></i>
          <p className="fs-5 mt-4 text-center">You can only delete this item Permanently</p>
        </Modal.Body>
        <Modal.Footer>
          <button
            type="button"
