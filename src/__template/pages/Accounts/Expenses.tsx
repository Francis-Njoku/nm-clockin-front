...
import { ExpensesData } from 'global/data/AppData'
          ...
          return (
            <div className="d-flex w-sm-100 col-auto">
              <button
                ...
                <i className="icofont-plus-circle fs-6 me-2"></i>Add Expenses
              </button>
            </div>
          )
        }}
        ...
        <Modal.Body>
          <div className="mb-3">
            ...
            <input
              ...
              id="item"
              onClick={() => {}}
              value={isEditModalData ? isEditModalData.item : ''}
            />
          </div>
              ...
              <div className="row g-3 mb-3">
                <div className="col-sm-6">
                  ...
                  <input
                    ...
                    id="depone"
                    onClick={() => {}}
                    value={isEditModalData ? isEditModalData.orderby : ''}
                  />
                </div>
                <div className="col-sm-6">
              ...
              <div className="row g-3 mb-3">
                <div className="col-sm-6">
                  ...
                  <input
                    ...
                    id="deptwo"
                    onClick={() => {}}
                    value={isEditModalData ? isEditModalData.from : ''}
                  />
                </div>
                <div className="col-sm-6">
