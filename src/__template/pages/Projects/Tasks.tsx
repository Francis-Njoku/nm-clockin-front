...
import { CompletedData, InProgressTaskData, needReviewData } from 'global/data/AppData'

import { Modal } from 'react-bootstrap'

import AllocatedTask from 'global/__template/components/Projects/AllocatedTask'
import RecentActivity from 'global/__template/components/Projects/RecentActivity'
import TaskNestable1 from 'global/__template/components/Projects/TaskNestable1'
import TaskProgress from 'global/__template/components/Projects/TaskProgress'
          ...
          return (
            <div className="d-flex w-sm-100 col-auto">
              <button
                ...
                <i className="icofont-plus-circle fs-6 me-2"></i>Create Task
              </button>
            </div>
          )
        }}
