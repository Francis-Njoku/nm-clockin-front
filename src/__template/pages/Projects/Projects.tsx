...
import { ProjectCardData } from 'global/data/AppData'
    ...
    <div className="container-xxl">
      <Tab.Container defaultActiveKey="All">
        <PageHeader
          ...
          renderRight={() => {
            return (
              <div className="d-flex project-tab w-sm-100 flex-wrap py-2">
                <button
                  type="button"
                  ...
                  <i className="icofont-plus-circle fs-6 me-2"></i>Create Project
                </button>
                <Nav
                  variant="pills"
                  className="nav nav-tabs tab-body-header prtab-set w-sm-100 ms-3 rounded">
                  <Nav.Item>
          ...
          <div className="col-lg-12 col-md-12 flex-column">
            <Tab.Content>
              <Tab.Pane eventKey="All">
                <div className="row g-3 gy-5 row-deck py-3">
