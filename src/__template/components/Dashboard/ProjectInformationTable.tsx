    ...
    <div className="card mb-3">
      <div className="card-header d-flex justify-content-between align-items-center py-3">
        <div className="info-header">
          <h6 className="fw-bold mb-0">Project Information</h6>
        </div>
      </div>
          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="table-responsive">
                <table
                  id="myProjectTable"
                  className="table-hover nowrap dataTable no-footer dtr-inline mb-0 table align-middle"
                  role="grid"
                  ...
                  <tbody>
                    <tr role="row" className="odd">
                      ...
                      <td className="dt-body-right">
                        <img src={Avatar4} alt="Aatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Peter</a>
                      </td>
                      <td>
                    ...
                    <tr role="row" className="even">
                      ...
                      <td>2 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar7} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Benjamin</a>
                      </td>
                      <td>
                        <div className="progress">
                    ...
                    <tr role="row" className="odd">
                      ...
                      <td>10 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar5} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Evan</a>
                      </td>
                      <td>
                        <div className="progress">
                    ...
                    <tr role="row" className="even">
                      ...
                      <td>8 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar6} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Connor</a>
                      </td>
                      <td>
                        <div className="progress">
                    ...
                    <tr role="row" className="odd">
                      ...
                      <td>1 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar2} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Colin</a>
                      </td>
                      <td>
                        <div className="progress">
                    ...
                    <tr role="row" className="even">
                      ...
                      <td>2 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar3} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Adam</a>
                      </td>
                      <td>
                        <div className="progress">
                    ...
                    <tr role="row" className="odd">
                      ...
                      <td>4 Month</td>
                      <td className="dt-body-right">
                        <img src={Avatar1} alt="Avatar" className="avatar sm rounded-circle me-2" />
                        <a href="#!">Keith</a>
                      </td>
                      <td>
                        <div className="progress">
