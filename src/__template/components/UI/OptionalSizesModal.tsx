    ...
    <div className="border-top mt-5 pt-3">
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link osmodal-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'osmodal-nav-Preview1', 'osmodal-tab-pane-1', 'osmodal-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link osmodal-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'osmodal-nav-HTML1', 'osmodal-tab-pane-1', 'osmodal-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade osmodal-tab-pane-1 active show"
              id="osmodal-nav-Preview1"
              role="tabpanel">
              <button
                type="button"
            ...
            <div
              className="tab-pane fade osmodal-tab-pane-1"
              id="osmodal-nav-HTML1"
              role="tabpanel">
              <SyntaxHighlighter
                language="javascript"
