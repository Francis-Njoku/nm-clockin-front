    ...
    <div className="col-12">
      <div className="card p-4 bd-content">
        ...
        <p>
          ...
          sizing and <code>em</code> units. As of v5, badges no longer have focus or hover styles
          for links.
        </p>
...
<h6>Example heading <Badge variant="secondary" className="bg-secondary">New</Badge></h6>`}
        ...
        <div className="bd-example mb-5">
          <button type="button" className="btn btn-primary">
            Notifications{' '}
            <Badge variant="light" className="bg-secondary">
              9
            </Badge>
          </button>
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight}>
...
Notifications <Badge variant="light" className="bg-secondary">9</Badge>
        ...
        <p>
          ...
          readers and similar assistive technologies. While the styling of badges provides a visual
          cue as to their purpose, these users will simply be presented with the content of the
          badge. Depending on the specific situation, these badges may seem like random additional
          words or numbers at the end of a sentence, link, or button.
        </p>
        <p>
          Unless the context is clear (as with the “Notifications” example, where it is understood
          that the “4” is the number of notifications), consider including additional context with a
    ...
    Profile <Badge variant="light" className="bg-secondary">9</Badge>
        ...
        <p>
          Use our background utility classes to quickly change the appearance of a badge. Please
          note that when using Bootstrap’s default <code>.bg-light</code>, you’ll likely need a text
          color utility like <code>.text-dark</code> for proper styling. This is because background
          utilities do not set anything but <code>background-color</code>.
        </p>
        <div className="bd-example mb-5">
          <Badge variant="primary" className="bg-secondary">
            Primary
          </Badge>{' '}
          <Badge variant="secondary" className="bg-success">
            Secondary
          </Badge>{' '}
          <Badge variant="success" className="bg-danger">
            Success
          </Badge>{' '}
          <Badge variant="danger" className="bg-warning">
            Danger
          </Badge>{' '}
          <Badge variant="warning" className="bg-info">
            Warning
          </Badge>{' '}
          <Badge variant="info" className="bg-info">
            Info
          </Badge>{' '}
          <Badge variant="light" className="bg-light">
            Light
          </Badge>{' '}
          <Badge variant="dark" className="bg-dark">
            Dark
          </Badge>
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight}>
...
<Badge variant="dark" className="bg-dark">Dark</Badge>`}
        ...
        <div className="bd-example mb-5">
          <Badge pill variant="primary" className="rounded-pill bg-secondary">
            Primary
          </Badge>{' '}
          <Badge pill variant="secondary" className="rounded-pill bg-success">
            Secondary
          </Badge>{' '}
          <Badge pill variant="success" className="rounded-pill bg-danger">
            Success
          </Badge>{' '}
          <Badge pill variant="danger" className="rounded-pill bg-warning">
            Danger
          </Badge>{' '}
          <Badge pill variant="warning" className="rounded-pill bg-info">
            Warning
          </Badge>{' '}
          <Badge pill variant="info" className="rounded-pill bg-info">
            Info
          </Badge>{' '}
          <Badge pill variant="light" className="rounded-pill bg-light">
            Light
          </Badge>{' '}
          <Badge pill variant="dark" className="rounded-pill bg-dark">
            Dark
          </Badge>
          <SyntaxHighlighter language="javascript" className="mt-2 language-html" style={a11yLight}>
