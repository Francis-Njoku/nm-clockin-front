  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        <a href="https://v5.getbootstrap.com/docs/5.0/utilities/spacing/">spacing utilities</a>.
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link text-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'text-nav-Preview1', 'text-tab-pane-1', 'text-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link text-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'text-nav-Preview2', 'text-tab-pane-1', 'text-nav-link-1')
            }}>
            HTML
          </a>
        </li>
