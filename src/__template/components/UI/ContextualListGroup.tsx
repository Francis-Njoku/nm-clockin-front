...
function ContextualListGroup() {
  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        Contextual classes also work with <code>.list-group-item-action</code>. Note the addition of
        the hover styles here not present in the previous example. Also supported is the{' '}
        <code>.active</code> state; apply it to indicate an active selection on a contextual list
        group item.
      </p>
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link contextual-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(
                e,
                'contextual-nav-Preview1',
                'contextual-tab-pane-1',
                'contextual-nav-link-1'
              )
            }}>
            Preview
          </a>
        ...
        <li className="nav-item">
          <a
            className="nav-link contextual-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'contextual-nav-HTML1', 'contextual-tab-pane-1', 'contextual-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade contextual-tab-pane-1 show active"
              id="contextual-nav-Preview1"
              role="tabpanel">
              <div className="row">
            ...
            <div
              className="tab-pane fade contextual-tab-pane-1"
              id="contextual-nav-HTML1"
              role="tabpanel">
              <SyntaxHighlighter
                language="javascript"
