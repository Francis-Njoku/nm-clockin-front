    ...
    <div className="border-top mt-5 pt-3">
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link vcmodal-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'vcmodal-nav-Preview1', 'vcmodal-tab-pane-1', 'vcmodal-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link vcmodal-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'vcmodal-nav-HTML1', 'vcmodal-tab-pane-1', 'vcmodal-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade vcmodal-tab-pane-1 active show"
              id="vcmodal-nav-Preview1"
              role="tabpanel">
              <button
                type="button"
            ...
            <div
              className="tab-pane fade vcmodal-tab-pane-1"
              id="vcmodal-nav-HTML1"
              role="tabpanel">
              <SyntaxHighlighter
                language="javascript"
