  ...
  return (
    ...
    <button type="button" className="btn btn-primary">Right</button>
      ...
      <div className="bd-callout bd-callout-warning">
        <h5 id="ensure-correct-role-and-provide-a-label">
        ...
        <p>
          ...
          attribute. In the examples provided here, we use <code>aria-label</code>, but alternatives
          such as <code>aria-labelledby</code> can also be used.
        </p>
      </div>

      <p>
        These classes can also be added to groups of links, as an alternative to the{' '}
        <a href="/docs/5.0/components/navs/">
          <code>.nav</code> navigation components
        </a>
        .
      </p>
      <div className="bd-example mb-5">
    ...
    <button type="button" className="btn btn-outline-primary">Right</button>
      ...
      <p>
        ...
        <a href="/docs/5.0/forms/checks-radios/">toggle buttons</a> into a seamless looking button
        group.
      </p>
      <div className="bd-example mb-5">
      ...
      <div className="bd-example mb-5">
        <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
          <input
            ...
            name="btnradio"
            id="btnradio1"
            checked={isCheckRadio1}
            onChange={() => {
              setIsCheckRadio1(!isCheckRadio1)
            }}
          />
          <label
            className="btn btn-outline-primary"
          ...
          <input
            ...
            name="btnradio"
            id="btnradio2"
            checked={isCheckRadio2}
            onChange={() => {
              setIsCheckRadio2(!isCheckRadio2)
            }}
          />
          <label
            className="btn btn-outline-primary"
          ...
          <input
            ...
            name="btnradio"
            id="btnradio3"
            checked={isCheckRadio3}
            onChange={() => {
              setIsCheckRadio3(!isCheckRadio3)
            }}
          />
          <label
            className="btn btn-outline-primary"
    ...
    <div className="btn-group" role="group" aria-label="Third group">
      ...
      <p>
        Feel free to mix input groups with button groups in your toolbars. Similar to the example
        above, you’ll likely need some utilities though to space things properly.
      </p>
      <div className="bd-example mb-5">
