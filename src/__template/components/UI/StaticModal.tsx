    ...
    <div className="border-top mt-5 pt-3">
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link smodal-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'smodal-nav-Preview1', 'smodal-tab-pane-1', 'smodal-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link smodal-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'smodal-nav-HTML1', 'smodal-tab-pane-1', 'smodal-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade smodal-tab-pane-1 active show"
              id="smodal-nav-Preview1"
              role="tabpanel">
              <button
                type="button"
