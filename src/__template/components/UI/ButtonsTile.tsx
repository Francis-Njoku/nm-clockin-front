...
<button type="button" className="btn btn-link">Link</button>`}
      ...
      <div className="bd-callout bd-callout-info">
        ...
        <p>
          ...
          denoted by the color is either obvious from the content itself (e.g. the visible text), or
          is included through alternative means, such as additional text hidden with the{' '}
          <code>.visually-hidden</code> class.
        </p>
      </div>
      <h2 id="disable-text-wrapping">Disable text wrapping</h2>
      <p>
        If you don’t want the button text to wrap, you can add the <code>.text-nowrap</code> class
        to the button. In Sass, you can set <code>$btn-white-space: nowrap</code> to disable text
      ...
      <p>
        When using button classes on <code>&lt;a&gt;</code> elements that are used to trigger
        in-page functionality (like collapsing content), rather than linking to new pages or
        sections within the current page, these links should be given a <code>role="button"</code>{' '}
        to appropriately convey their purpose to assistive technologies such as screen readers.
      </p>
      <div className="bd-example mb-5">
        <a className="btn btn-primary me-1" href="#!" role="button">
          Link
        </a>
...
<button type="button" className="btn btn-secondary btn-sm">Small button</button>`}
      ...
      <div className="bd-example mb-5">
        <button type="button" className="btn btn-primary btn-lg btn-block me-1">
          Block level button
        </button>
...
<button type="button" className="btn btn-secondary btn-lg btn-block">Block level button</button>`}
      ...
      <div className="bd-example mb-5">
        <button type="button" className="btn btn-lg btn-primary me-1" disabled="">
          Primary button
        </button>
...
<button type="button" className="btn btn-secondary btn-lg" disabled="">Button</button>`}
      ...
      <ul>
        ...
        <li>
          Some future-friendly styles are included to disable all <code>pointer-events</code> on
          anchor buttons.
        </li>
        <li>
          Disabled buttons should include the <code>aria-disabled="true"</code> attribute to
...
<a href="#" className="btn btn-secondary btn-lg disabled" tabindex="-1" role="button" aria-disabled="true">Link</a>`}
      ...
      <div className="bd-callout bd-callout-warning">
        ...
        <p>
          The <code>.disabled</code> class uses <code>pointer-events: none</code> to try to disable
          ...
          these links. So to be safe, in addition to <code>aria-disabled="true"</code>, also include
          a <code>tabindex="-1"</code> attribute on these links to prevent them from receiving
      ...
      <div className="card p-4 mb-5 shadow-sm">
        ...
        <a href="https://v5.getbootstrap.com/docs/5.0/forms/checks-radios/#checkbox-toggle-buttons">
          checkbox toggle buttons
        </a>
        . However, they are conveyed differently by assistive technologies: the checkbox toggles
        will be announced by screen readers as “checked”/“not checked” (since, despite their
        appearance, they are fundamentally still checkboxes), whereas these toggle buttons will be
        announced as “button”/“button pressed”. The choice between these two approaches will depend
        on the type of toggle you are creating, and whether or not the toggle will make sense to
        users when announced as a checkbox or as an actual button.
      </div>
      <h3 id="toggle-states">Toggle states</h3>
      <p>
        Add <code>data-bs-toggle="button"</code> to toggle a button’s <code>active</code> state. If
      ...
      <div className="bd-example mb-5">
        <button type="button" className="btn btn-primary me-1" data-bs-toggle="button">
          Toggle button
        </button>
        <button
          type="button"
...
<button type="button" className="btn btn-primary" disabled="" data-toggle="button" autocomplete="off">Disabled toggle button</button>`}
      ...
      <div className="bd-example mb-5">
        <a href="#!" className="btn btn-primary me-1" role="button" data-bs-toggle="button">
          Toggle link
        </a>
        <a
          href="#!"
