          ...
          <div className="tab-content">
            <div
              ...
              <div
                ...
                data-offset="0"
                style={{ height: '200px', overflowY: 'scroll', position: 'relative' }}>
                <h5 id="fat">@fat</h5>
                <p>
                ...
                <h5 id="one">one</h5>
                <p>
                  Occaecat commodo aliqua delectus. Fap craft beer deserunt skateboard ea. Lomo
                  bicycle rights adipisicing banh mi, velit ea sunt next level locavore
                  single-origin coffee in magna veniam. High life id vinyl, echo park consequat quis
                ...
                <p>
                  ...
                  readymade velit. VHS chambray laboris tempor veniam. Anim mollit minim commodo
                  ullamco thundercats.
                </p>
              </div>
            </div>
