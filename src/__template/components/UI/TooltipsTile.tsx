    ...
    <div className="col-12">
      <div className="bd-content">
        ...
        <div className="alert alert-danger" role="alert">
          <strong>Tooltips</strong> for more bootstrao components{' '}
          <a href="https://v5.getbootstrap.com/docs/5.0/components/tooltips/" target="_blank">
            Bootstrap Tooltips documentation <i className="fa fa-external-link"></i>
          </a>
        </div>
        <ul>
          <li>
            Tooltips rely on the 3rd party library <a href="https://popper.js.org/">Popper.js</a>{' '}
            ...
            <code>bootstrap.bundle.js</code> which contains Popper.js in order for tooltips to work!
          </li>
          <li>
          ...
          <li>
            Tooltips for <code>.disabled</code> or <code>disabled</code> elements must be triggered
            on a wrapper element.
          </li>
          <li>
            When triggered from hyperlinks that span multiple lines, tooltips will be centered. Use{' '}
            <code>white-space: nowrap;</code> on your <code>&lt;a&gt;</code>s to avoid this
            behavior.
          </li>
          <li>
            Tooltips must be hidden before their corresponding elements have been removed from the
            DOM.
          </li>
          ...
          <div className="card p-4 mb-3 shadow">
            <p className="mb-0 text-muted">
              ...
              <a
                ...
                data-bs-toggle="tooltip"
                title=""
                data-bs-original-title="Another tooltip">
                have a
              </a>{' '}
              ...
              <a href="#!" data-bs-toggle="tooltip" title="" data-bs-original-title="The last tip!">
                twitter handle
              </a>{' '}
          ...
          <div className="card mb-3">
            <div className="card-body">
              <div className="tab-content">
                <div
                  className={basicT === 'Preview' ? 'tab-pane fade show active' : 'tab-pane fade'}
                  id="nav-Preview1"
                  role="tabpanel">
                ...
                <div
                  className={basicT === 'Html' ? 'tab-pane fade show active' : 'tab-pane fade'}
                  id="nav-HTML1"
                  role="tabpanel">
                  <SyntaxHighlighter
                    language="javascript"
