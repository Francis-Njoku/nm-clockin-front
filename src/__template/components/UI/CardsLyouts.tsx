...
import Thumbnail1 from 'global/assets/images/gallery/1.jpg'
import Thumbnail2 from 'global/assets/images/gallery/2.jpg'
import Thumbnail3 from 'global/assets/images/gallery/3.jpg'
import Thumbnail4 from 'global/assets/images/gallery/4.jpg'
import Thumbnail5 from 'global/assets/images/gallery/5.jpg'
import Thumbnail6 from 'global/assets/images/gallery/6.jpg'
import Thumbnail7 from 'global/assets/images/gallery/7.jpg'
import Thumbnail8 from 'global/assets/images/gallery/8.jpg'
import Thumbnail9 from 'global/assets/images/gallery/9.jpg'
import Thumbnail10 from 'global/assets/images/gallery/10.jpg'
import Thumbnail11 from 'global/assets/images/gallery/11.jpg'
    ...
    <div className="col-lg-8 col-sm-12">
      <div className="card">
        <div className="card-body">
          ...
          <p>
            A <strong>card</strong> is a flexible and extensible content container. It includes
            options for headers and footers, a wide variety of content, contextual background
            colors, and powerful display options. If you’re familiar with Bootstrap 3, cards replace
            our old panels, wells, and thumbnails. Similar functionality to those components is
          ...
          <p>
            ...
            deliver a ton of control and customization. Built with flexbox, they offer easy
            alignment and mix well with other Bootstrap components. They have no <code>margin</code>{' '}
            by default, so use <a href="/docs/5.0/utilities/spacing/">spacing utilities</a> as
            needed.
          </p>
          <p>
            Below is an example of a basic card with mixed content and a fixed width. Cards have no
            fixed width to start, so they’ll naturally fill the full width of its parent element.
            This is easily customized with our various <a href="#sizing">sizing options</a>.
          </p>
...
<div className="card" style={{width: '18rem'}}>
    ...
    <div className="card-body">
        ...
        <a href="#!" className="btn btn-primary">Go somewhere</a>
          ...
          <h3 id="body">Body</h3>
          <p>
            The building block of a card is the <code>.card-body</code>. Use it whenever you need a
    ...
    <div className="card-body">
        This is some text within a card body.
          ...
          <p>
            Card titles are used by adding <code>.card-title</code> to a <code>&lt;h*&gt;</code>{' '}
            tag. In the same way, links are added and placed next to each other by adding{' '}
            <code>.card-link</code> to an <code>&lt;a&gt;</code> tag.
          </p>
          <p>
            Subtitles are used by adding a <code>.card-subtitle</code> to a <code>&lt;h*&gt;</code>{' '}
...
<div className="card" style={{width:'18rem'}}>
    ...
    <div className="card-body">
        ...
        <a href="#!" className="btn btn-primary">Go somewhere</a>
          ...
          <p>
            Card headers can be styled by adding <code>.card-header</code> to{' '}
    ...
    <div className="col-sm-6">
        <div className="card">
          ...
          <p>
            Use our handful of{' '}
            <a href="https://v5.getbootstrap.com/docs/5.0/utilities/sizing/">
    ...
    <div className="card-body">
        ...
        <a href="#!" className="btn btn-primary">Go somewhere</a>
          ...
          <p>
            ...
            parts—with our{' '}
            <a href="https://v5.getbootstrap.com/docs/5.0/utilities/text/#text-alignment">
              text align classes
            </a>
            .
          </p>
...
<div className="card text-end" style={{width:'18rem'}}>
    <div className="card-body">
        ...
        <a href="#!" className="btn btn-primary">Go somewhere</a>
          ...
          <p>
            ...
            <a href="https://v5.getbootstrap.com/docs/5.0/components/navs/">nav components</a>.
          </p>
          <div className="bd-example mb-5">
            <div className="card text-center">
              <div className="card-header">
    ...
    <div className="card-body">
        ...
        <a href="#!" className="btn btn-primary">Go somewhere</a>
          ...
          <p>
            Cards include a few options for working with images. Choose from appending “image caps”
            at either end of a card, overlaying images with card content, or simply embedding the
            image in a card.
          </p>
          <h3 id="image-caps">Image caps</h3>
          <p>
            Similar to headers and footers, cards can include top and bottom “image caps”—images at
            the top or bottom of a card.
          </p>
          <div className="bd-example mb-5">
...
<div className="card">
    ...
    <img className="card-img-top" src={Thumbnail8} alt="" />
          ...
          <p>
            Turn an image into a card background and overlay your card’s text. Depending on the
            image, you may or may not need additional styles or utilities.
          </p>
          <div className="bd-example mb-5">
          ...
          <div className="card mb-5 p-3 shadow-sm">
          ...
          <p>
            ...
            with <code>.g-0</code> and use <code>.col-md-*</code> classes to make the card
...
<div className="card mb-3" >
    <div className="row g-0">
        ...
        <div className="col-md-8">
          ...
          <p>
            Use{' '}
            <a href="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">
              text and background utilities
            </a>{' '}
            to change the appearance of a card.
          </p>
          <div className="bd-example mb-5">
            <div className="card mb-3 bg-primary text-white" style={{ width: '18rem' }}>
            ...
            <div className="card mb-3 bg-secondary text-white" style={{ width: '18rem' }}>
              <div className="card-header">Header</div>
              <div className="card-body">
            ...
            <div className="card bg-success mb-3 text-white" style={{ width: '18rem' }}>
              <div className="card-header">Header</div>
              <div className="card-body">
            ...
            <div className="card bg-danger mb-3 text-white" style={{ width: '18rem' }}>
              <div className="card-header">Header</div>
              <div className="card-body">
        ...
        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          ...
          <div className="card p-3 shadow-sm">
            ...
            <p>
              ...
              visible text), or is included through alternative means, such as additional text
          ...
          <p>
            Use{' '}
            <a href="https://v5.getbootstrap.com/docs/5.0/utilities/borders/">border utilities</a>{' '}
            to change just the <code>border-color</code> of a card. Note that you can put{' '}
            <code>.text-{'{color}'}</code> classes on the parent <code>.card</code> or a subset of
          ...
          <div className="bd-example mb-5">
            ...
            <div className="card mb-3 border-secondary" style={{ width: '18rem' }}>
              <div className="card-header">Header</div>
...
<div className="card border-dark mb-3" style={{width:'18rem'}}>
    ...
    <div className="card-body text-dark">
        ...
        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
          ...
          <p>
            ...
            their <code>background-color</code> with <code>.bg-transparent</code>.
          </p>
          <div className="bd-example mb-5">
            <div className="card border-success mb-3" style={{ width: '18rem' }}>
              <div className="card-header border-success bg-transparent">Header</div>
              <div className="card-body text-success">
                <h5 className="card-title">Success card title</h5>
                <p className="card-text">
                  Some quick example text to build on the card title and make up the bulk of the
              ...
              <div className="card-footer border-success bg-transparent">Footer</div>
            </div>
            <SyntaxHighlighter
              language="javascript"
              className="language-html mt-2 px-2 py-2"
    ...
    <div className="card-footer bg-transparent border-success">Footer</div>
          ...
          <p>
            ...
            laying out series of cards. For the time being,{' '}
    ...
    <div className="card">
        ...
        <div className="card-footer">
          ...
          <p>
            ...
            <a href="https://v5.getbootstrap.com/docs/5.0/layout/grid/#row-columns">
            ...
            <code>.row-cols-md-2</code> splitting four cards to equal width across multiple rows,
...
<div className="row row-cols-1 row-cols-md-2 g-4">
    ...
    <div className="col">
        <div className="card">
          ...
          <p>
            Change it to <code>.row-cols-3</code> and you’ll see the fourth card wrap.
          </p>
          <div className="bd-example mb-5">
...
<div className="row row-cols-1 row-cols-md-3 g-4">
    ...
    <div className="col">
        <div className="card">
          ...
          <p>
            When you need equal height, add <code>.h-100</code> to the cards. If you want equal
            heights by default, you can set <code>$card-height: 100%</code> in Sass.
          </p>
          <div className="bd-example mb-5">
            <div className="row row-cols-1 row-cols-md-3 g-4">
              <div className="col">
...
<div className="row row-cols-1 row-cols-md-3 g-4">
    ...
    <div className="col">
        <div className="card h-100">
          ...
          <p>
            In <code>v4</code> we used a CSS-only technique to mimic the behavior of{' '}
            <a href="https://masonry.desandro.com/">Masonry</a>-like columns, but this technique
            came with lots of unpleasant{' '}
            <a href="https://github.com/twbs/bootstrap/pull/28922">side effects</a>. If you want to
            have this type of layout in <code>v5</code>, you can just make use of Masonry plugin.{' '}
            <strong>Masonry is not included in Bootstrap</strong>, but we’ve made a{' '}
            <a href="https://v5.getbootstrap.com/docs/5.0/examples/masonry/">demo example</a> to
