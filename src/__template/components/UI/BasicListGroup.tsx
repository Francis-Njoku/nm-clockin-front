    ...
    <div className="border-top mt-5 pt-3">
      ...
      <ul className="nav nav-tabs tab-card border-bottom-0 px-3" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-Preview1', 'blist-tab-pane-1', 'blist-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-HTML1', 'blist-tab-pane-1', 'blist-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade blist-tab-pane-1 show active"
              id="blist-nav-Preview1"
              role="tabpanel">
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6">
                  <ul className="list-group list-group-custom">
                    <li className="list-group-item">
                      <span className="badge me-2 bg-primary">14</span>
                      Cras justo odio
                    </li>
                    <li className="list-group-item">
                    ...
                    <li className="list-group-item">
                      <span className="badge me-2 bg-secondary">1</span>
                      Morbi leo risus
                    </li>
                  </ul>
                </div>
                <div className="col-lg-3 col-md-6">
                  <ul className="list-group list-group-custom">
                    <li className="list-group-item d-flex justify-content-between align-items-center">
                      Cras justo odio
                      <span className="badge rounded-pill bg-primary">14</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center">
                      Dapibus ac facilisis in
...
<ul className="list-group">
    ...
    <li className="list-group-item">
      ...
      <ul className="nav nav-tabs tab-card border-bottom-0 px-3" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-2 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-Preview2', 'blist-tab-pane-2', 'blist-nav-link-2')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-2"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-HTML2', 'blist-tab-pane-2', 'blist-nav-link-2')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade blist-tab-pane-2 show active"
              id="blist-nav-Preview2"
              role="tabpanel">
              <div className="row">
                  ...
                  <ul className="list-unstyled list-group list-group-custom list-group-flush mb-0">
                    <li className="list-group-item d-flex py-3">
                      ...
                      <div className="flex-grow-1">
                        <h6 className="mb-0">
                          7 New Feedback <small className="float-right text-muted">Today</small>
                        </h6>
                    ...
                    <li className="list-group-item d-flex py-3">
                      ...
                      <div className="flex-grow-1">
                        <h6 className="mb-0">
                          New User <small className="float-right text-muted">10:45</small>
                        </h6>
                    ...
                    <li className="list-group-item d-flex py-3">
                      ...
                      <div className="flex-grow-1">
                        <h6 className="text-warning mb-0">
                          Server Warning <small className="float-right text-muted">10:50</small>
                        </h6>
                    ...
                    <li className="list-group-item d-flex py-3">
                      ...
                      <div className="flex-grow-1">
                        <h6 className="text-danger mb-0">
                          Issue Fixed <small className="float-right text-muted">11:05</small>
                        </h6>
                    ...
                    <li className="list-group-item d-flex py-3">
                      ...
                      <div className="flex-grow-1">
                        <h6 className="mb-0">
                          7 New Orders <small className="float-right text-muted">11:35</small>
                        </h6>
...
<ul className="list-unstyled list-group list-group-custom list-group-flush mb-0">
    ...
    <li className="list-group-item d-flex align-items-center py-3">
      ...
      <p>
        Add <code>.disabled</code> to a <code>.list-group-item</code> to make it <em>appear</em>{' '}
        disabled. Note that some elements with <code>.disabled</code> will also require custom
        JavaScript to fully disable their click events (e.g., links).
      </p>
      <ul className="nav nav-tabs tab-card border-bottom-0 px-3" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-3 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-Preview3', 'blist-tab-pane-3', 'blist-nav-link-3')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link blist-nav-link-3"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'blist-nav-HTML3', 'blist-tab-pane-3', 'blist-nav-link-3')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade blist-tab-pane-3 show active"
              id="blist-nav-Preview3"
              role="tabpanel">
              <ul className="list-group list-group-custom">
