  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        <a href="https://v5.getbootstrap.com/docs/5.0/utilities/api/">utilities</a>, or adding your
        own markup. Here we’ve created a simpler toast by removing the default{' '}
        <code>.toast-header</code>, adding a custom hide icon from{' '}
        <a href="https://icons.getbootstrap.com/">Bootstrap Icons</a>, and using some{' '}
        <a href="https://v5.getbootstrap.com/docs/5.0/utilities/flex/">flexbox utilities</a> to
        adjust the layout.
      </p>
          ...
          <div className="tab-content">
            <div
              ...
              <p>
                ...
                <a href="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">color utilities</a>
                . Here we’ve added <code>.bg-primary</code> and <code>.text-white</code> to the{' '}
                <code>.toast</code>, and then added <code>.text-white</code> to our close button.
                For a crisp edge, we remove the default border with <code>.border-0</code>.
              </p>
              ...
              <Toast>
                <Toast.Body>
                  ...
                  <div className="mt-2 pt-2 border-top">
                    ...
                    <button type="button" className="btn btn-secondary btn-sm" data-dismiss="toast">
                      Close
                    </button>
                  </div>
                </Toast.Body>
