          ...
          <div className="tab-content">
            <div
                ...
                <div
                  ...
                  <Toast style={{ position: 'absolute', top: 0, right: 0 }}>
                    <Toast.Header closeButton={false}>
                      <img src={Avatar10} className="avatar sm me-2 rounded" alt="" />
              ...
              <p className="mb-1 mt-4">
                For systems that generate more notifications, consider using a wrapping element so
                they can easily stack.
              </p>
              <div className="bg-dark p-3">
