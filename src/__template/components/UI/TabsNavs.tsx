...
function TabsNavs() {
  ...
  return (
    <div className="border-top mt-5 pt-3">
      <h3 id="tabs">Tabs</h3>
      <p>
        Takes the basic nav from above and adds the <code>.nav-tabs</code> class to generate a
        tabbed interface.
      </p>
      <Tabs
        ...
        className=" px-3 border-bottom-0">
        <Tab eventKey="Preview" title="Preview">
          <div className="card mb-3">
            <div className="card-body">
              Takes the basic nav from above and adds the{' '}
              <code>.nav .nav-tabs .px-3 .border-bottom-0</code> class to generate a tabbed
              interface.
            </div>
          </div>
        </Tab>
    ...
    <Tab eventKey="disabled" title="Disabled" disabled>
        ...
        <Tab title="Link"></Tab>
        <Tab eventKey="disabled" title="Disabled" disabled></Tab>
      </Tabs>
      <div className="card mb-3">
        <div className="card-body">
          <Tabs
            ...
            <Tab eventKey="Preview" title="Preview">
              <div className="card-body">
                Takes the basic nav from above and adds the <code>.nav .nav-tabs </code> class to
      ...
      <div className="card mb-3">
        <div className="card-body">
          <Tabs
            ...
            <Tab eventKey="Preview" title="Preview">
              <div className="card-body">
                Takes the basic nav from above and adds the .nav nav-tabs .tab-card class to
                generate a tabbed interface.
              </div>
            </Tab>
            <Tab eventKey="html" title="HTML">
          ...
          <Tab.Container id="left-tabs-example" defaultActiveKey="preview6" className="px-3">
            ...
            <Tab.Content>
              <Tab.Pane eventKey="preview6">
                <div className="card-body">
                  <div
                    className="tab-pane fade tnodal-tab-link-4 active show"
                    id="tnodal-nav-Preview4"
                    role="tabpanel">
                    Takes the basic nav from above and adds the <code>.nav nav-tabs .tab-card</code>{' '}
