...
function BasicModal() {
  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        Below is a <em>static</em> modal example (meaning its <code>position</code> and{' '}
        <code>display</code> have been overridden). Included are the modal header, modal body
        (required for <code>padding</code>), and modal footer (optional). We ask that you include
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link bmodal-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'bmodal-nav-Preview1', 'bmodal-tab-pane-1', 'bmodal-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link bmodal-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'bmodal-nav-HTML1', 'bmodal-tab-pane-1', 'bmodal-nav-link-1')
            }}>
            HTML
          </a>
        </li>
      ...
      <div className="card mb-3 bg-transparent">
        <div className="card-body">
          <div className="tab-content">
            <div
              className="tab-pane fade bmodal-tab-pane-1 active show"
              id="bmodal-nav-Preview1"
              role="tabpanel">
              <button
                type="button"
