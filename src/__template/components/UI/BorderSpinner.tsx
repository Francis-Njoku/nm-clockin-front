  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        <a href="https://v5.getbootstrap.com/docs/5.0/utilities/colors/">text color utilities</a>.
...
<Spinner animation="border" variant="dark" />`}
      ...
      <div className="card card-callout p-3">
        <span>
          <strong>
            Why not use <code>border-color</code> utilities?
          </strong>{' '}
          Each border spinner specifies a <code>transparent</code> border for at least one side, so{' '}
