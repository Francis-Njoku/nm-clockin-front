  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        for links that appear un-clickable and <code>.active</code> to indicate the current page.
      </p>
      <p>
        While the <code>.disabled</code> class uses <code>pointer-events: none</code> to{' '}
        <em>try</em> to disable the link functionality of <code>&lt;a&gt;</code>s, that CSS property
        is not yet standardized and doesn’t account for keyboard navigation. As such, you should
        always add <code>tabindex="-1"</code> on disabled links and use custom JavaScript to fully
        ...
        <div className="card-body">
          <div className="tab-content">
            <div
              ...
              <p>
                You can optionally swap out active or disabled anchors for <code>&lt;span&gt;</code>
