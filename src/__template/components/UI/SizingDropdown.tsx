    ...
    <div className="border-top mt-5 pt-3">
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link sizing-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'sizing-nav-Preview1', 'sizing-tab-pane-1', 'sizing-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link sizing-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'sizing-nav-Preview2', 'sizing-tab-pane-1', 'sizing-nav-link-1')
            }}>
            HTML
          </a>
        </li>
