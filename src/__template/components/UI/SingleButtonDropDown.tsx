      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            ...
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-Preview1', 'tab-pane-1', 'nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            ...
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-HTML1', 'tab-pane-1', 'nav-link-1')
            }}>
            HTML
          </a>
        </li>
...
<Dropdown className="d-inline-flex m-1">
    ...
    <Dropdown.Menu as="ul" className="dropdown-menu-dark shadow p-3">
      ...
      <p>
        And with <code>&lt;a&gt;</code> elements:
      </p>
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link nav-link-2 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-Preview2', 'tab-pane-2', 'nav-link-2')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            ...
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-HTML2', 'tab-pane-2', 'nav-link-2')
            }}>
            HTML
          </a>
        </li>
...
<Dropdown className="d-inline-flex m-1">
    ...
    <Dropdown.Menu as="ul" className="dropdown-menu-dark shadow p-3">
      ...
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link nav-link-3 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-Preview3', 'tab-pane-3', 'nav-link-3')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            ...
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'nav-HTML3', 'tab-pane-3', 'nav-link-3')
            }}>
            HTML
          </a>
        </li>
