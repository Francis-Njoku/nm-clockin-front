  ...
  return (
    <div className="border-top mt-5 pt-3">
      ...
      <p>
        ...
        caret by 25% and remove the <code>margin-left</code> that’s added for regular button
        dropdowns. Those extra changes keep the caret centered in the split button and provide a
        more appropriately sized hit area next to the main button.
      </p>
      <ul className="nav nav-tabs tab-card px-3 border-bottom-0" role="tablist">
        <li className="nav-item">
          <a
            className="nav-link split-nav-link-1 active"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'split-nav-Preview1', 'split-tab-pane-1', 'split-nav-link-1')
            }}>
            Preview
          </a>
        </li>
        <li className="nav-item">
          <a
            className="nav-link split-nav-link-1"
            href="#!"
            onClick={(e) => {
              e.preventDefault()
              tabEvent(e, 'split-nav-Preview2', 'split-tab-pane-1', 'split-nav-link-1')
            }}>
            HTML
          </a>
        </li>
