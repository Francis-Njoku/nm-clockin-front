        ...
        <div className="card p-4 bd-content">
          ...
          <ul>
            <li>
              ...
              <code>bootstrap.bundle.js</code> which contains Popper.js in order for tooltips to
              work!
            </li>
            <li>
            ...
            <li>
              Tooltips for <code>.disabled</code> or <code>disabled</code> elements must be
              triggered on a wrapper element.
            </li>
            <li>
              When triggered from hyperlinks that span multiple lines, tooltips will be centered.
              Use <code>white-space: nowrap;</code> on your <code>&lt;a&gt;</code>s to avoid this
              behavior.
            </li>
            <li>
            ...
            <div className="card p-4 mb-3 shadow">
              <p className="mb-0 text-muted">
                ...
                <a
                  ...
                  data-bs-toggle="tooltip"
                  title=""
                  data-bs-original-title="The last tip!">
                  twitter handle
                </a>{' '}
