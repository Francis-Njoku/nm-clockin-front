...
import ButtonsSpinner from '../UI/ButtonsSpinner'
import GrowingSpinner from '../UI/GrowingSpinner'
import SizeSpinner from '../UI/SizeSpinner'
      ...
      <div className="col-12">
        <div className="card bd-content p-4">
          ...
          <p>
            ...
            built only with HTML and CSS, meaning you don’t need any JavaScript to create them. You
            will, however, need some custom JavaScript to toggle their visibility. Their appearance,
            alignment, and sizing can be easily customized with our amazing utility classes.
          </p>
          <p>
            For accessibility purposes, each loader here includes <code>role="status"</code> and a
            nested <code>&lt;span class="visually-hidden"&gt;Loading...&lt;/span&gt;</code>.
          </p>
