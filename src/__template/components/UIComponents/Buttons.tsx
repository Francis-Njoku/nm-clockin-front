...
import ButtonsGroupTile from '../UI/ButtonsGroupTile'
import ButtonsTile from '../UI/ButtonsTile'
      ...
      <div className="col-12">
        <div className="card mb-4 border-0 shadow-sm">
          <div className="card-body">
            <ul className="nav nav-tabs tab-body-header d-inline-flex rounded" role="tablist">
            ...
            <div className="row justify-content-between">
              ...
              <div className="col-lg-3 col-sm-12 d-none d-sm-block">
                <div className="sticky-lg-top">
                  <strong className="d-block h6 border-bottom my-2 pb-2">On this page</strong>
                  <nav>
                    <ul>
                      <li>
                      ...
                      <li>
                        <a href="#disable-text-wrapping">Disable text wrapping</a>
                      </li>
                      <li>
                        <a href="#button-tags">Button tags</a>
                      </li>
                      <li>
                        <a href="#outline-buttons">Outline buttons</a>
                      </li>
                      <li>
                        <a href="#sizes">Sizes</a>
                      </li>
                      <li>
                        <a href="#disabled-state">Disabled state</a>
                      </li>
                      <li>
                        <a href="#button-plugin">Button plugin</a>
                        <ul>
                          <li>
                            <a href="#toggle-states">Toggle states</a>
                          </li>
                          <li>
                ...
                <div className="sticky-lg-top">
                  ...
                  <nav>
                    <ul>
                      ...
                      <li>
                        <a href="#mixed-styles">Mixed styles</a>
                      </li>
                      <li>
                        <a href="#outlined-styles">Outlined styles</a>
                      </li>
                      <li>
                        <a href="#checkbox-and-radio-button-groups">
                      ...
                      <li>
                        <a href="#vertical-variation">Vertical variation</a>
                      </li>
                    </ul>
                  </nav>
                </div>
