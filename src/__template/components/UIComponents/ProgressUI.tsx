...
import BasicProgress from '../UI/BasicProgress'
    ...
    <div
      ...
      <div className="col-12">
        <div className="card bd-content ps-lg-4 p-4">
          ...
          <ul>
            <li>
              We use the <code>.progress</code> as a wrapper to indicate the max value of the
              progress bar.
            </li>
            <li>
            ...
            <li>
              The <code>.progress-bar</code> requires an inline style, utility class, or custom CSS
              to set their width.
            </li>
            <li>
              The <code>.progress-bar</code> also requires some <code>role</code> and{' '}
          ...
          <div className="bd-example card mb-3 p-3">
            <ProgressBar now={75} />
            <SyntaxHighlighter
              language="javascript"
          ...
          <p>
            We only set a <code>height</code> value on the <code>.progress</code>, so if you change
            that value the inner <code>.progress-bar</code> will automatically resize accordingly.
          </p>
          <div className="bd-example card mb-3 p-3">
...
<ProgressBar now={100} variant="danger" className="mb-3" />`}
    ...
    <ProgressBar variant="info" now={20} key={2} />
          ...
          <p>
            Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code> to apply a
