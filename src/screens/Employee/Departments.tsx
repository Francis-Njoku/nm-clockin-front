  ...
  return (
    <div className="container-xxl">
          ...
          return (
            <div className="d-flex w-sm-100 col-auto">
              <button
                ...
                <i className="icofont-plus-circle fs-6 me-2"></i>Add Departments
              </button>
            </div>
          )
        }}
      ...
      <Modal
        ...
        <Modal.Body>
          <div className="mb-3">
            <label htmlFor="exampleFormControlInput1111" className="form-label">
              Department Name
            </label>
            <input
              type="text"
              ...
              onClick={() => {}}
              value={isEditModalData ? isEditModalData.DepartmentName : ''}
            />
          </div>
              ...
              <div className="row g-3 mb-3">
                <div className="col-sm-6">
                  ...
                  <input
                    ...
                    id="depone"
                    onClick={() => {}}
                    value={isEditModalData ? isEditModalData.DepartmentHead : ''}
                  />
                </div>
                <div className="col-sm-6">
                  ...
                  <input
                    ...
                    id="deptwo"
                    onClick={() => {}}
                    value={isEditModalData ? isEditModalData.employeeNo : ''}
                  />
                </div>
              </div>
            </form>
